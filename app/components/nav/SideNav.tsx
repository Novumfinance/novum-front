import boostSrc from '~/assets/boost.jpg'
import whaleSrc from '~/assets/whale.jpg'
import oethSrc from '~/assets/oeth.svg'
import ethSrc from '~/assets/ETH.svg'
import friendsSrc from '~/assets/friend.jpg'
import { Tooltip } from '~/components/Tooltip'
import { CopyReferrerLink } from '~/components/CopyReferrerLink'

const boxClass = `border border-gray-border rounded-3xl px-4 pt-6 pb-4 flex flex-col items-center justify-center w-full  bg-white`
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      <div className={boxClass}>
        <img src={friendsSrc} className="w-16 h-16" alt="friends" />
        <div className="font-medium leading-relaxed text-purple-500">Invite Friends</div>
        <div className={descriptionClass}>
          Get 15% more Novum Points by referring your friends
        </div>
      ...
      <div className={boxClass}>
        <img src={boostSrc} className="w-16 h-16" alt="boost" />
        <div className="font-medium leading-relaxed text-purple-500">Early Boost!</div>
        <div className={descriptionClass}>
          Be an early depositor and earn even more Novum Points
        </div>
      ...
      <div className={boxClass}>
        <img src={whaleSrc} className="w-16 h-16" alt="whale" />
        <div className="font-medium leading-relaxed text-purple-500">Whale Multipiers</div>
        <div className={descriptionClass}>
      ...
      {/* <div className={boxClass}>
        ...
        <div className="text-gray-500 mt-2">
          ...
          >
            2x bonus applies only to novETH minted with OETH and held in the
            same wallet
          </Tooltip>
        </div>
      </div> */}
