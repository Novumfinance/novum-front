  ...
  return (
    <>
      <button ref={refs.setReference} {...getReferenceProps()}>
        {
          img ?
            <img className={imgClass} src={img} alt={altStr} />
            :
      ...
      <FloatingPortal>
        {transitions(
          (styles, item) =>
            item && (
              <animated.div
                className={`bg-white border border-gray-border shadow-xl rounded-lg relative leading-tight max-w-[350px] z-20 ${className}`}
