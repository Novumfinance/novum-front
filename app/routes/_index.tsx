...
//             <span className="text-purple-500 font-black">novETH</span>
//           </div>
//           <div className="text-gray-500 text-lg md:text-3xl mt-6 md:mt-6 max-w-[1086px] z-10 text-balance font-heading">
//             Stack ETH staking yield, EigenLayer points, and Novum Points
...
//               />
//               <div className="text-sm sm:text-4xl text-center text-balance leading-snug sm:leading-relaxed sm:mt-5">
//                 <div className="text-purple-500">novETH</div>
//                 XP
//               </div>
//             </div>
//           </div>
...
//               To start earning, just deposit ETH and get novETH in return. The
...
//             <span className="text-purple-500">novETH</span>
...
//             How do I acquire <span className="text-purple-500">novETH</span>?
//           </div>
...
//               <div className="flex items-center justify-center bg-purple-500 rounded-full h-16 w-16 sm:h-24 sm:w-24 mt-1">
//                 <img
//                   src={EthSimpleSrc}
//                   alt="ETH"
...
//           answer="Withdrawals will be enabled in the near future. Liquidity is available on Uniswap enabling conversion of novETH to ETH for those needing to exit."
//         />
//       </div>
//       <Footer />
//     </>
