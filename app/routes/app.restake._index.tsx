...
import novumEthSVG from '~/assets/novETH_token.svg'
...
export default function Index() {
  ...
  const MAX_APPROVE = '1000000000000000000000000'
  ...
  if (data) {
    try {
      ...
      assetBalance = isConnected ? asset.toLowerCase() === 'ETH'.toLowerCase() ? ethBal.data?.value : (data[5].result ?? 0n ) : 0n
    ...
    try {
      ...
      youWillGet = (rawAssetPrice * depositAmountBI) / novETHPrice
    } catch (e) {
      console.log(e)
      console.log(data)
      /* Ignore */
    ...
    <>
        ...
        <div className="py-4 px-4 sm:py-6 sm:px-6  flex flex-col gap-4 border-b border-gray-border">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-1 font-medium">
              ...
              <img src={novumEthSVG} alt="novETH" className="h-7 rounded-full" />
              novETH
            </div>
          </div>
          <div className="flex justify-between items-center">
            <div className="text-gray-500 text-sm flex items-center gap-1">
              ...
              <Tooltip className="p-2 text-sm text-gray-900">
                novETH grows in value. It will be worth more than what you restake.
              </Tooltip>
               :
              </div>
            <div className="text-sm">
              {`${formatEth(assetPrice)} ${asset} = 1 novETH`}
            </div>
          </div>
          {
            getReferrerId() === 'Origin' ? null : (
            <div className="flex justify-between items-center">
              <div className="text-gray-500 text-sm flex items-center gap-1">
                Referral Bonus
                <Tooltip className="p-2 text-sm text-gray-900">
                  You were referred by {base62ToHex(getReferrerId())}
                </Tooltip>
              </div>
            ...
            onClick={() => {
              ...
              if (depositAmountBI > assetAllowance) {
                contractWrite.writeContract({
                  ...
                  args: [contracts.lrtDepositPool, MAX_APPROVE],
                })
      ...
      <div className="p-6 bg-white rounded-b-3xl flex flex-col gap-2">
        <div className="flex items-center justify-between text-sm">
          <div>Restaking limit for Mainnet early depositors</div>
        ...
        <div className="rounded-full bg-gray-500/20">
          <div
            className="rounded-full bg-purple-500 h-[8px]"
